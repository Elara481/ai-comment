...
const i18n = {
  ja: {
    ...
    squarePageSubtitle: '社畜たちによる仕事の本音・評価の共有スペース。誰でも匿名でコメント・共感できます！',
    squarePublishTitle: '自分の仕事・今日の一日を評価して共有する',
    squareAuthorPlaceholder: 'ニックネーム（省略可：匿名社畜）',
    squareJobPlaceholder: '職種 / 役職（例：エンジニア、営業、事務、新入社員...）',
    squareWorkRatingLabel: '自分の仕事に対する自己評価：',
    squareContentPlaceholder: '仕事に対する本音や評価、悩み、社畜あるあるを書いてみよう（300文字以内）...',
    squarePublishBtn: '広場に投稿する',
    squarePublishingBtn: '投稿中...',
    squareRefreshBtn: '🔄 最新の投稿を読み込む',
    squareEmpty: 'まだ広場への投稿がありません。最初の投稿をしてみましょう！',
    squareLikeBtn: '👍 共感する',
    squareLikedBtn: '❤️ 共感済み',
    squareReplyToggle: (count) => `💬 匿名コメント (${count})`,
    squareReplyPlaceholder: '匿名でコメントやアドバイスを残す...（200文字以内）',
    squareNickPlaceholder: 'ニックネーム（省略可：匿名社畜）',
    squareReplySubmit: '送信する',
    squareReplyEmptyErr: 'コメント内容を入力してください。',
    squarePostSuccess: '✅ 広場に投稿しました！',
    // contact
  ...
  zh: {
    ...
    squarePageSubtitle: '打工人对工作的真实评价与心声阵地。自由分享，所有人均可匿名互动评论！',
    squarePublishTitle: '发表我对当前工作的真实评价与心声',
    squareAuthorPlaceholder: '昵称（选填，默认：匿名打工人）',
    squareJobPlaceholder: '岗位 / 职业（例：程序员、运营、销售、设计、人事...）',
    squareWorkRatingLabel: '这份工作/今日状态打分：',
    squareContentPlaceholder: '写下你对这份工作的真实评价、待遇槽点、加班心声或职场体验（300字以内）...',
    squarePublishBtn: '发布到广场',
    squarePublishingBtn: '发布中...',
    squareRefreshBtn: '🔄 刷新最新动态',
    squareEmpty: '广场上还没有内容，快来发布第一条工作心声吧！',
    squareLikeBtn: '👍 共鸣/点赞',
